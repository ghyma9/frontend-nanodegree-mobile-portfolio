...
var pizzasDiv = document.getElementById("randomPizzas");    // Moved out from the for loop to save computing time
for (var i = 2; i < 100; i++) {
...
var scrollTop = document.body.scrollTop / 1250;   // Prevent FSL
